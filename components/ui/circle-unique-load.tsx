...
export function Loading({ screenHFull = true }: loadingProps) {
  ...
  return (
    <div className={`${screenHFull ? "min-h-[200px]" : ""} relative flex flex-col items-center justify-center`}>
      ...
      <p className="text-sm font-bold uppercase tracking-widest text-center mt-4">
        {loadText}
